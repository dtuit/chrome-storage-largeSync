...
syncMore2 = (function(){
	...
	var chromeStore = chrome.storage.sync;
	...
	var getkeyPrefix = function(){return keyPrefix;};
	var setkeyPrefix = function(val){keyPrefix = val;};

	var get = function(){};
	var set = function(){};
	var remove = function(){};
	var getBytesInUse = function(){};
	var clear = function(){};
	...
	var api = {
		...
		QUOTA_BYTES : chromeSync.QUOTA_BYTES,
		QUOTA_BYTES_PER_ITEM : chromeSync.QUOTA_BYTES_PER_ITEM,
